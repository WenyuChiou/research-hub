...
def test_fallback_merges_by_doi(mock_openalex, _mock_arxiv, mock_s2):
...
@patch("research_hub.search.fallback.ArxivBackend.search")
@patch("research_hub.search.fallback.OpenAlexBackend.search")
def test_fallback_merges_by_arxiv_id_when_no_doi(mock_openalex, mock_arxiv, mock_s2):
...
@patch("research_hub.search.fallback.ArxivBackend.search")
@patch("research_hub.search.fallback.OpenAlexBackend.search")
def test_fallback_prefers_first_backend_for_non_empty_fields(mock_openalex, mock_arxiv, mock_s2):
...
@patch("research_hub.search.fallback.ArxivBackend.search")
@patch("research_hub.search.fallback.OpenAlexBackend.search")
def test_fallback_skips_failing_backend(mock_openalex, mock_arxiv, mock_s2):
...
@patch("research_hub.search.fallback.ArxivBackend.search")
@patch("research_hub.search.fallback.OpenAlexBackend.search")
def test_fallback_respects_min_citations_filter(mock_openalex, mock_arxiv, mock_s2):
...
@patch("research_hub.search.fallback.ArxivBackend.search")
@patch("research_hub.search.fallback.OpenAlexBackend.search")
def test_fallback_sorts_by_year_desc_then_citations_desc(mock_openalex, mock_arxiv, mock_s2):
    mock_openalex.return_value = [
