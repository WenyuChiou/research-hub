...
Run in sequence:
```cmd
cd /d C:\Users\wenyu\knowledge-base && set PYTHONPATH=C:\Users\wenyu\knowledge-base
C:\Python314\python.exe build_hub.py
C:\Python314\python.exe categorize_graph.py
C:\Python314\python.exe fix_orphans.py
```
...
| PYTHONPATH not set | Prepend `set PYTHONPATH=C:\Users\wenyu\knowledge-base` |
