# Changelog -- pre-1.0 archive

> Historical entries: the v1.0.0 pre-release planning notes and every
> v0.95.x / v0.9x / earlier release. Current + recent releases live in
