...
[![Tests](https://img.shields.io/badge/tests-1247%20passing-brightgreen.svg)](docs/audit_v0.33.md)
...
- **Latest**: v0.33.0 (2026-04-17)
- **Tests**: 1247 passing, 14 skipped, 2 xfail baselines (documented search-quality issues)
...
- [Audit reports](docs/) — `audit_v0.26.md` … `audit_v0.33.md`
...
python -m pytest -q  # 1247 passing
```
